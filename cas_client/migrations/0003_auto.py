...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field instructors on 'Outcome'
        db.create_table('cas_client_outcome_instructors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('outcome', models.ForeignKey(orm['cas_client.outcome'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('cas_client_outcome_instructors', ['outcome_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field instructors on 'Outcome'
        db.delete_table('cas_client_outcome_instructors')
