...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field instructors on 'Subject'
        db.create_table('cas_client_subject_instructors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subject', models.ForeignKey(orm['cas_client.subject'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('cas_client_subject_instructors', ['subject_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field instructors on 'Subject'
        db.delete_table('cas_client_subject_instructors')
    ...
    models = {
        ...
        'cas_client.module': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'modules_creator'", 'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '600', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'modules_instructors'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
        ...
        'cas_client.outcome': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'outcomes_creator'", 'to': "orm['auth.User']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'outcomes_intructors'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
        ...
        'cas_client.subject': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subjects_creator'", 'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'subjects_instructors'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
