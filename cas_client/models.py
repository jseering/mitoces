...
class Outcome(models.Model):
    ...
    prerequisites = models.ManyToManyField(Outcome, related_name='postrequisites', blank=True, null=True, symmetrical=False)
...
class Subject(models.Model):
    ...
    year          = models.CharField(max_length=4,
                                     ...
                                     blank=True,
                                     null=True)
    prerequisites = models.ManyToManyField(Subject, related_name='postrequisites', blank=True, null=True, symmetrical=False)
    def __unicode__(self):
