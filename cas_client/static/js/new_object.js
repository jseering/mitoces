$(function(){
    ...
    $('a[link_type="new"]').click(function(){
        ...
        var win = window.open("/"+object_type+"s/add/", "Add " + object_type, 'height=800,width=600,resizable=yes,scrollbars=yes');
    });    
    ...
    $('img.add').click(function(){
        ...
        var win = window.open("/"+parent_object_type+"s/"+parent_object_id+"/add/"+this_object_type+"/", "Add " + this_object_type, 'height=600,width=600,resizable=yes,scrollbars=yes');
    });
