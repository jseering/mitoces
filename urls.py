...
urlpatterns = patterns('',
    ...
    url(r'^modules/(?P<module_id>\d+)/get/description/$', 'cas_client.views.get_description_of_module', name="get description of module"),
    url(r'^modules/(?P<module_id>\d+)/add/subject/$', 'cas_client.views.add_subject_to_module', name="add subject to module"),
    url(r'^modules/(?P<module_id>\d+)/remove/subject/(?P<subject_id>\d+)/$', 'cas_client.views.remove_subject_from_module', name="remove subject from module"),  
    ...
    url(r'^outcomes/(?P<outcome_id>\d+)/add/outcome/$', 'cas_client.views.add_prereq_to_outcome', name="add prereq to outcome"),
    url(r'^outcomes/(?P<outcome_id>\d+)/add/outcome/(?P<prereq_id>\d+)/$', 'cas_client.views.add_existing_prereq_to_outcome', name="add existing prereq to outcome"),
    url(r'^outcomes/(?P<outcome_id>\d+)/add/module/(?P<module_id>\d+)/$', 'cas_client.views.add_existing_module_to_outcome', name="add existing module to outcome"),
    url(r'^outcomes/(?P<outcome_id>\d+)/add/module/$', 'cas_client.views.add_module_to_outcome', name="add module to outcome"),
    url(r'^outcomes/(?P<outcome_id>\d+)/add/subject/$', 'cas_client.views.add_subject_to_outcome', name="add subject to outcome"),
    ...
    url(r'^subjects/(?P<subject_id>\d+)/editname/$', 'cas_client.views.edit_subject_name', name="edit subject name"),
    url(r'^subjects/(?P<subject_id>\d+)/editnumber/$', 'cas_client.views.edit_subject_number', name="edit subject number"),
    url(r'^subjects/(?P<subject_id>\d+)/editdescription/$', 'cas_client.views.edit_subject_description', name="edit subject description"),
    url(r'^subjects/(?P<subject_id>\d+)/add/module/$', 'cas_client.views.add_module_to_subject', name="add module to subject"),
    url(r'^subjects/(?P<subject_id>\d+)/add/module/(?P<module_id>\d+)/$', 'cas_client.views.add_existing_module_to_subject', name="add existing module to subject"),
    url(r'^subjects/(?P<subject_id>\d+)/remove/module/(?P<module_id>\d+)/$', 'cas_client.views.remove_subject_from_module', name="remove module from subject"),  
    url(r'^subjects/(?P<subject_id>\d+)/add/subject/(?P<prereq_id>\d+)/$', 'cas_client.views.add_existing_prereq_to_subject', name="add existing prereq to subject"),
    url(r'^subjects/(?P<subject_id>\d+)/add/subject/$', 'cas_client.views.add_prereq_to_subject', name="add prereq to subject"),
    url(r'^subjects/(?P<subject_id>\d+)/get/description/$', 'cas_client.views.get_description_of_subject', name="get description of subject"),
    url(r'^subjects/(?P<subject_id>\d+)/remove/subject/(?P<prereq_id>\d+)/$', 'cas_client.views.remove_prereq_from_subject', name="remove prereq from subject"),  
    url(r'^subjects/add/$', 'cas_client.views.add_subject', name="add subject"),
